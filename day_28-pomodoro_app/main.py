...
timer_text = canvas.create_text(100, 138, text="0:00", fill="white", font=(FONT_NAME, 35, "bold"))
canvas.grid(column=1, row=1)

start_button = Button(text="Start", bg=YELLOW, bd=0, highlightthickness=0, command=start_timer)
